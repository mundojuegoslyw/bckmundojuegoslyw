<template>
	<header
		class="backdrop-blur-md sticky top-0 z-50 border-b border-slate-100 shadow-xs bg-linear-to-t from-olive-700 to-slate-100"
	>
		<div
			class="max-w-7xl mx-auto px-4 h-28 sm:h-28 flex items-center justify-between"
		>
			<div
